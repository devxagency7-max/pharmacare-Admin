...
async function loadBellNotifications() {
    ...
    try {
        ...
        pharmItems.forEach(app => entries.push({
            icon: 'bx-plus-medical', iconBg: '#eff6ff', iconColor: '#3b82f6',
        ...
        internItems.forEach(app => entries.push({
            icon: 'bx-book-reader', iconBg: '#f0fdf4', iconColor: '#16a34a',
        ...
        orderItems.forEach(order => entries.push({
            icon: 'bx-cart', iconBg: '#fffbeb', iconColor: '#d97706',
            title: 'New Order',
...
// Stub — no dedicated unread-count endpoint for admins; badge is driven by loadPendingCounts()
async function pollUnreadCount() { /* no-op */ }
